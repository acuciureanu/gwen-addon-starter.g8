...
trait MathEvalEngine extends EvalEngine[MathEnvContext] {
  ...
  override def init(options: GwenOptions, scopes: ScopedDataStack): MathEnvContext = new MathEnvContext(new MathService(), options, scopes)
...
class MathInterpreter extends GwenInterpreter[MathEnvContext] with MathEvalEngine

object MathInterpreter extends GwenApp(new MathInterpreter)
